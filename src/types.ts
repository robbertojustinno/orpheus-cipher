...
export type AuditEventType = 'COMMAND_EXECUTED'|'ENIGMA_OPENED'|'ENIGMA_ATTEMPTED'|'HINT_UNLOCKED'|'ENIGMA_SOLVED'|'UNLOCK_APPLIED'|'DOSSIER_ACCESSED'|'SECRET_COMMAND_DISCOVERED'|'MISSION_UPDATED'
