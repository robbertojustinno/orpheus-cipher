...
export function createInitialPersistedNarrativeState():PersistedNarrativeState{
  return{version:2,narrativeState:'INITIAL',firstDetectionCompleted:false,missionStarted:false,founderId:SYSTEM_CONFIG.founderId,founderTotal:SYSTEM_CONFIG.founderTotal,enigmas:Object.fromEntries(enigmaDefinitions.map(enigma=>[enigma.id,{status:'locked',progress:0,attempts:0,hintsUnlocked:[]}])),unlockedFiles:[],unlockedMessages:[],unlockedDossiers:[],unlockedMapNodes:[],restoredFragments:[],discoveredCommands:[],auditEvents:[],campaignCompleted:false,secretDiscoveries:[],unlockedBadges:[]}
}
